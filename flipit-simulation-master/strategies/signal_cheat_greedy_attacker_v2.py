...
class SignalCheatGreedyAttackerV2:
    ...
    def __init__(
        ...
        self.action_floor = float(action_floor)
    ...
    def select_action(self, public_state: Dict[str, object]) -> int:
        ...
        target_feasible = budget - target_cost >= self.action_floor
        cheat_feasible = allow_cheat and budget - self.cheat_cost >= self.action_floor
        if not target_feasible and not cheat_feasible:
            return 0
        ...
        if cheat_feasible:
            ...
            if last_deception_zone == distraction_zone and focus_zone == distraction_zone and target_feasible:
        ...
        if target_feasible and signal == NULL_SIGNAL:
            return ZONE_TO_ATTACKER_TAKEOVER_ACTION[target_zone]
